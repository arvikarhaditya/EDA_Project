...
The downloaded binary packages are in
	/var/folders/n1/s5s6lg4n18gdnkd_8h37g21c0000gn/T//Rtmpy5szQN/downloaded_packages
> library(readr)
...
> plot(feb_data$Time, feb_data$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)")
> dev.off()
null device 
          1 
> 
